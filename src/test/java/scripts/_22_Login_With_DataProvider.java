...
public class _22_Login_With_DataProvider extends Base{
    ...
    @Test(priority = 1, description = "Validate Login with different credentials", dataProvider = "loginData")
    public void validateLoginAttempts(String username, String password, String message){
